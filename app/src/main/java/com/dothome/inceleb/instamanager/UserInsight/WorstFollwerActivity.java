package com.dothome.inceleb.instamanager.UserInsight;
...
import com.dothome.inceleb.instamanager.Home.DetailActivity;
import com.dothome.inceleb.instamanager.Model.Follow;
import com.dothome.inceleb.instamanager.R;

import java.util.ArrayList;

public class WorstFollwerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_worst_follwer);

        list.add(new Follow("AA","B",""));
    ...
    public class ListAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.listitem_bestfollow, parent, false);
            }
            ...
            TextView tv_rank = (TextView) convertView.findViewById(R.id.list_rank) ;
            if(position<3){
